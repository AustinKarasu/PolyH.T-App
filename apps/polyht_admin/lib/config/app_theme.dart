...
class AppTheme {
  ...
  static final cardShadow = [
    BoxShadow(color: primary.withValues(alpha: 0.06), blurRadius: 16, offset: const Offset(0, 4)),
  ];
  ...
  static ThemeData get light {
    final scheme = ColorScheme.fromSeed(
      ...
      tertiary: accent, surface: surface, error: error, brightness: Brightness.light,
    );
  ...
  static ThemeData get dark {
    final scheme = ColorScheme.fromSeed(
      seedColor: primary, primary: primaryLight, secondary: secondary,
      tertiary: accent, surface: darkSurface, error: error, brightness: Brightness.dark,
    );
  ...
  static ThemeData _buildTheme(ColorScheme scheme, Brightness brightness) {
    ...
    final borderColor = isDark ? primaryLight.withValues(alpha: 0.15) : primaryLight.withValues(alpha: 0.12);
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(borderRadius: BorderRadius.circular(radiusMd), borderSide: BorderSide(color: borderColor)),
        enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(radiusMd), borderSide: BorderSide(color: borderColor)),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          side: BorderSide(color: isDark ? primaryLight.withValues(alpha: 0.4) : primaryLight),
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(foregroundColor: isDark ? primaryLight : primary, textStyle: const TextStyle(fontWeight: FontWeight.w600)),
      ),
      ...
      cardTheme: CardThemeData(
        elevation: 0, color: card, surfaceTintColor: Colors.transparent,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(radiusLg), side: BorderSide(color: borderColor)),
        margin: const EdgeInsets.symmetric(vertical: 4),
      ),

      floatingActionButtonTheme: FloatingActionButtonThemeData(
        backgroundColor: isDark ? primaryLight : primary, foregroundColor: isDark ? darkBg : Colors.white,
        elevation: 6, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(radiusLg)),
      ),

      chipTheme: ChipThemeData(
        backgroundColor: primaryLight.withValues(alpha: isDark ? 0.2 : 0.12),
        labelStyle: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: isDark ? primaryLight : primaryDark),
      ...
      tabBarTheme: const TabBarThemeData(
        ...
        indicatorColor: secondary, indicatorSize: TabBarIndicatorSize.tab,
      ...
      textTheme: TextTheme(
        headlineLarge: TextStyle(fontSize: 30, fontWeight: FontWeight.w800, color: textColor, letterSpacing: -0.5),
        headlineMedium: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: textColor, letterSpacing: -0.25),
        ...
        labelLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, letterSpacing: 0.5, color: textColor),
      ),
    );
  }
}
